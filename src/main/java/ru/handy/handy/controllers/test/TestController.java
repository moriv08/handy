...
public class TestController {
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_SUPERUSER', 'ROLE_EXPERT')")
    @GetMapping("/http")
    public String http(Model model, HttpHeaders client){
//        String version = client.bodyPublisher().toString();
        Map<String, List<String>> map = client.map();
        ...
        for(Map.Entry<String, List<String>> iter: map.entrySet()) {
            ...
            iter.getValue().stream().forEach(System.out::println);
        }
